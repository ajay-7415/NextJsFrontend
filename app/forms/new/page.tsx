...
export default function NewFormPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await api.post('/forms', { title, fields: fieldsWithOrder });
    ...
    if (!user) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#0B0C15]">
                <div className="text-xl text-white">Please login to create forms</div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#0B0C15] py-8 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-4xl relative z-10">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent mb-2">Create New Form</h1>
                    <p className="text-slate-100">Build your custom form with drag-and-drop</p>
                </div>
