...
export default function PublicFormPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('Submitting to:', `/submissions/${form!._id}`); // Debug log
        ...
        <div className="min-h-screen bg-[#0B0C15] py-12 px-4 relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto relative z-10">
                <div className="bg-[#FFFFFF0D] backdrop-blur-md border border-[#FFFFFF1A] rounded-2xl p-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent mb-2">{form!.title}</h1>
